...
void MainMenu::loadResources()
{
	...
	textMission1  = new GUIText("DRAGON ROAD",    2.0f, font, 0.0f, 0.0f, 0.5f-128*px, false, true, true); INCR_NEW
	textMission2  = new GUIText("THUNDER ROAD",   2.0f, font, 0.0f, 0.0f, 0.5f-128*px, false, true, true); INCR_NEW
	textMission3  = new GUIText("BIG BLUE",       2.0f, font, 0.0f, 0.0f, 0.5f-128*px, false, true, true); INCR_NEW
	textMission4  = new GUIText("WARIO COLOSSEUM",2.0f, font, 0.0f, 0.0f, 0.5f-128*px, false, true, true); INCR_NEW
	textMission5  = new GUIText("CASINO PALACE",  2.0f, font, 0.0f, 0.0f, 0.5f-128*px, false, true, true); INCR_NEW
	textMission6  = new GUIText("RAINBOW ROAD",   2.0f, font, 0.0f, 0.0f, 0.5f-128*px, false, true, true); INCR_NEW
...
void MainMenu::selectMenuMission(int newSelection)
{
	...
	itemMission6 ->setY(yPos+offsetY);
	yPos = 0.5f+6.0f*py;
	...
	itemMissionBackdrop6 ->setY(yPos+offsetY);
	...
	textMission6 ->getPosition()->y = yPos+offsetY;
	...
	if (Global::gameState == STATE_TITLE)
	{
		...
		else if (menuSelectionID >= MISSION_1 && menuSelectionID <= MISSION_MAX)
		{
			...
			else if (pressedSelect)
			{
				switch (menuSelectionID)
				{
					case MISSION_1: Global::levelID = LVL_DRAGON_ROAD    ; break;
					case MISSION_2: Global::levelID = LVL_THUNDER_ROAD   ; break;
					case MISSION_3: Global::levelID = LVL_BIG_BLUE       ; break;
					case MISSION_4: Global::levelID = LVL_WARIO_COLOSSEUM; break;
					case MISSION_5: Global::levelID = LVL_CASINO_PALACE  ; break;
					case MISSION_6: Global::levelID = LVL_RAINBOW_ROAD   ; break;
					default:                                               break;
				}
